...
def save_checkpoint(episode, model, optimizer, epsilon, replay_buffer, filename="dqn_fs_checkpoint.pth", replay_filename="replay_buffer_fs.pkl"):
	shutil.copy('dqn_fs_checkpoint.pth', 'dqn_fs_checkpoint_prev.pth')
	shutil.copy('replay_buffer_fs.pkl', 'replay_buffer_fs_prev.pkl')
...
def load_checkpoint(model, optimizer, filename="dqn_fs_checkpoint.pth", buffer_file="replay_buffer_fs.pkl"): 
